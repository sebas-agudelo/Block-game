...
// const shapeColors = [
//     { shape: 'Z', color: 'e000ff' },
//     { shape: 'T', color: 'blue' },
//     { shape: 'O', color: 'green' },
//     { shape: 'U', color: 'ff7000' },
...
// // Hitta färg baserat på formen
// const getColorForShape = (shapeKey) => {
//     const shape = shapeColors.find(item => item.shape === shapeKey);
...
//     const blockColor = getColorForShape(shapeKey);
...
//                     slot.classList.remove(shapeColor.color);
